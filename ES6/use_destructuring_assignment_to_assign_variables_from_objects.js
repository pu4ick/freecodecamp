...
// You may read it as "get the value of user.name and assign it to 
// a new variable named userName" and so on. The value of userName would be the string John Doe, 
